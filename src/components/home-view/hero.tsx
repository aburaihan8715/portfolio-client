        ...
        <div className="flex py-2 md:py-10 md:flex-row flex-col items-center px-2">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0">
            ...
            <p className="mb-8 leading-relaxed text-gray-300">
              I am Abu Raihan a dedicated full-stack web developer with a passion for crafting web applications that combine functionality and
              aesthetics. I specialize in building robust web applications using React, Next js, MongoDB, Postgres and Node js. I am deeply passionate
              about web development and constantly seek opportunities to expand my knowledge.
            </p>
          ...
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 relative flex justify-end">
            <Image className="object-contain w-[90%] rounded-full border-4 border-gray-400" alt="hero" src={profilePhot} />

            <div className="absolute top-[70%] left-[-5%] px-8 py-4 flex flex-col rounded-md text-center bg-gray-700 animate-smooth-move">
